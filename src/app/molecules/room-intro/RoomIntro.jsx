...
function RoomIntro({
  roomId, avatarSrc, avatarAnimSrc, name, heading, desc, time,
}) {
  return (
    <tr className="welcome-msg">
      <td colSpan="2">
        <div className='ps-5 pt-5 pb-3'>
          <Avatar imageSrc={avatarSrc} imageAnimSrc={avatarAnimSrc} text={name} bgColor={colorMXID(roomId)} size="large" isDefaultImage />
